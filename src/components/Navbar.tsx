          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="ml-6 flex items-center">
              <div className="hidden lg:flex items-center space-x-3 mr-4">
                <a href="https://www.linkedin.com/in/nexhubcommunity/" target="_blank" rel="noopener noreferrer" 
                  className="text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary-light">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="https://github.com/NexHub-Community" target="_blank" rel="noopener noreferrer" 
                  className="text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary-light">
                ...
                <a href="https://www.instagram.com/nexhubcommunity/" target="_blank" rel="noopener noreferrer" 
                  className="text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary-light">
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <p className="px-3 text-sm font-medium text-gray-600 dark:text-gray-300">Connect with us</p>
            <div className="mt-2 px-3 flex space-x-6">
              <a href="https://www.linkedin.com/in/nexhubcommunity/" target="_blank" rel="noopener noreferrer" 
                className="text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary-light">
                <span className="sr-only">LinkedIn</span>
              ...
              <a href="https://www.youtube.com/channel/UCUHmRuQ9ELLTC9lVeTtEQpw" target="_blank" rel="noopener noreferrer" 
                className="text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary-light">
              ...
              <a href="https://chat.whatsapp.com/IrfYbZfyJGrF3KuPiM8ElH" target="_blank" rel="noopener noreferrer" 
                className="text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary-light">
